            ...
            if (res.data.length !== 0) {
                res.data.map(item => {
                    result.push({
                        ...
                        bpsBasis: item.data[0].absPrice.toFixed(4),
                        futurePrice: item.data[0].futurePrice.toFixed(4),
                        bidPrice: item.data[0].bidPrice.toFixed(4),
                        askPrice: item.data[0].askPrice.toFixed(4),
                        askSize: item.data[0].askSize.toFixed(4),
                        bidSize: item.data[0].bidSize.toFixed(4),
                        midPrice: item.data[0].midPrice.toFixed(4),
                        spotPrice: item.data[0].spotPrice.toFixed(4),
                        absBasis : (item.data[0].futurePrice - item.data[0].spotPrice).toFixed(4),
                    })
                })
                setRowData([...result])
            }
